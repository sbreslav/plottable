...
(function (Plottable) {
    ...
    (function (Utils) {
        ...
        (function (Math) {
            ...
            function valuesInDomain(values, domain) {
                var min = domain[0] <= domain[1] ? domain[0] : domain[1];
                var max = domain[0] >= domain[1] ? domain[0] : domain[1];
                if (min === domain[0]) {
                    return values.filter(function (i) { return i >= min && i <= max; });
                }
                else {
                    return values.filter(function (i) { return i >= min && i <= max; }).reverse();
                }
            }
            Math.valuesInDomain = valuesInDomain;
    ...
    (function (Utils) {
        ...
        (function (Tick) {
            function getTickValues(scale) {
                ...
                if (!Plottable.QuantitativeScale.prototype.isPrototypeOf(scale) || Plottable.Scales.InterpolatedColor.prototype.isPrototypeOf(scale)) {
                    return domain;
                }
                var ticks = scale.ticks();
                return Utils.Math.valuesInDomain(ticks, domain);
            }
            Tick.getTickValues = getTickValues;
            ;
            function generateTicks(tickMarkAttrHash, tickMarkLength, orientation, tickLabelPadding, tickLabelPositioning) {
            ...
            Tick.generateTicks = generateTicks;
            ;
            function generateTickMarkAttrHash(scale, width, height, orientation, tickLength) {
                ...
                var scalingFunction = function (d) { return scale.scale(d); };
                if (orientation === "top" || orientation === "bottom") {
            ...
            Tick.generateTickMarkAttrHash = generateTickMarkAttrHash;
            ;
            /**
             * Filters out visible selections
             */
            function visibleFilter(selection) {
                return selection.filter(function (d, i) {
                    var visibility = d3.select(this).style("visibility");
                    return (visibility === "inherit") || (visibility === "visible");
                });
            }
            Tick.visibleFilter = visibleFilter;
            ;
            /**
             *  Hides the Tick Marks which have no corresponding Tick Labels
             */
            function hideTickMarksWithoutLabel(tickMarks, tickLabels) {
                var labelNumbersShown = new Utils.Set();
                visibleFilter(tickLabels).each(function (labelNumber) { return labelNumbersShown.add(labelNumber); });
            ...
            Tick.hideTickMarksWithoutLabel = hideTickMarksWithoutLabel;
            ;
            /**
             *  Hides end ticks that are outside of boundingBox
             */
            function hideEndTickLabels(tickLabels, boundingBox) {
                if (tickLabels.empty()) {
                    return;
                }
            ...
            Tick.hideEndTickLabels = hideEndTickLabels;
            ;
            /**
             *  Hides ticks that are outside of boundingBox
             */
            function hideOverflowingTickLabels(tickLabels, boundingBox) {
                if (tickLabels.empty()) {
                    return;
                }
            ...
            Tick.hideOverflowingTickLabels = hideOverflowingTickLabels;
            ;
            function hideOverlappingTickLabels(tickLabels, orientation, tickLabelPositioning, defaultPadding) {
                var visibleTickLabels = visibleFilter(tickLabels);
                 ...
                 *
                 */
                function hasOverlapWithInterval(interval, rects) {
            ...
            Tick.hideOverlappingTickLabels = hideOverlappingTickLabels;
            ;
            function showAllTickMarks(tickMarks) {
                tickMarks.each(function () {
                    d3.select(this).style("visibility", "inherit");
                });
            }
            Tick.showAllTickMarks = showAllTickMarks;
        })(Tick = Utils.Tick || (Utils.Tick = {}));
    })(Utils = Plottable.Utils || (Plottable.Utils = {}));
})(Plottable || (Plottable = {}));
var Plottable;
(function (Plottable) {
    ...
    (function (Scales) {
        var InterpolatedColor = (function (_super) {
            ...
            function InterpolatedColor(scaleType) {
                ...
                _super.call(this);
                this._tickGenerator = function (scale) { return scale.domain(); };
                switch (scaleType) {
                    case "linear":
            ...
            InterpolatedColor.prototype.tickGenerator = function (generator) {
                if (generator == null) {
                    return this._tickGenerator;
                }
                else {
...
(function (Plottable) {
    var Axis = (function (_super) {
        ...
        Axis.prototype._generateTickMarkAttrHash = function (isEndTickMark) {
            ...
            return Plottable.Utils.Tick.generateTickMarkAttrHash(this._scale, this.width(), this.height(), this.orientation(), tickLength);
        };
    ...
    (function (Axes) {
        var Numeric = (function (_super) {
            ...
            Numeric.prototype._getTickValues = function () {
                return Plottable.Utils.Tick.getTickValues(this._scale);
            };
            ...
            Numeric.prototype.renderImmediately = function () {
                ...
                var tickLabelPositioning = this._tickLabelPositioning;
                var tickMarkAttrHash = this._generateTickMarkAttrHash();
                var tickLabelAttributes = Plottable.Utils.Tick.generateTicks(tickMarkAttrHash, tickMarkLength, this.orientation(), tickLabelPadding, tickLabelPositioning);
            ...
            Numeric.prototype._showAllTickMarks = function () {
                Plottable.Utils.Tick.showAllTickMarks(this._tickMarkContainer.selectAll("." + Plottable.Axis.TICK_MARK_CLASS));
            };
            /**
             * Hides the Tick Marks which have no corresponding Tick Labels
             */
            Numeric.prototype._hideTickMarksWithoutLabel = function () {
                ...
                Plottable.Utils.Tick.hideTickMarksWithoutLabel(tickMarks, tickLabels);
            };
            ...
            Numeric.prototype._hideEndTickLabels = function () {
                var boundingBox = this._boundingBox.node().getBoundingClientRect();
                var tickLabels = this._tickLabelContainer.selectAll("." + Plottable.Axis.TICK_LABEL_CLASS);
                Plottable.Utils.Tick.hideEndTickLabels(tickLabels, boundingBox);
            };
            ...
            Numeric.prototype._hideOverflowingTickLabels = function () {
                var boundingBox = this._boundingBox.node().getBoundingClientRect();
                var tickLabels = this._tickLabelContainer.selectAll("." + Plottable.Axis.TICK_LABEL_CLASS);
                Plottable.Utils.Tick.hideOverflowingTickLabels(tickLabels, boundingBox);
            };
            Numeric.prototype._hideOverlappingTickLabels = function () {
                var tickLabels = this._tickLabelContainer.selectAll("." + Plottable.Axis.TICK_LABEL_CLASS);
                Plottable.Utils.Tick.hideOverlappingTickLabels(tickLabels, this.orientation(), this._tickLabelPositioning, this.tickLabelPadding());
            };
            return Numeric;
        })(Plottable.Axis);
...
(function (Plottable) {
    ...
    (function (Components) {
        var InterpolatedColorLegend = (function (_super) {
            ...
            InterpolatedColorLegend.prototype._drawSwatches = function (numSwatches, swatchWidth, swatchHeight, swatchX, swatchY) {
                var _this = this;
            ...
            InterpolatedColorLegend.prototype._getTickValues = function () {
                return Plottable.Utils.Tick.getTickValues(this._scale);
            };
